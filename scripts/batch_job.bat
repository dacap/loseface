...
rem %LOSEFACE% mlp_array.lua %FACES% 50 50 %SUBJECTS% 0 mse > %FACES%/mlp_array_50_50_0neg.output
...
rem %LOSEFACE% mlp_array.lua %FACES% 50 50 %SUBJECTS% 3 mse > %FACES%/mlp_array_50_50_3neg.output
